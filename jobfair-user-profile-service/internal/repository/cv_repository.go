...
type CVRepository interface {
	...
	GetByID(id uuid.UUID) (*models.CVDocument, error)
	GetByProfileID(profileID uuid.UUID) (*models.CVDocument, error)
...
func (r *cvRepository) GetByID(id uuid.UUID) (*models.CVDocument, error) {
	var cv models.CVDocument
	err := r.db.Where("id = ?", id).First(&cv).Error
	return &cv, err
}

func (r *cvRepository) GetByProfileID(profileID uuid.UUID) (*models.CVDocument, error) {
	var cv models.CVDocument
...
func (r *cvRepository) Delete(id uuid.UUID) error {
